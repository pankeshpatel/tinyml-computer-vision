'''
            -----------------------------------------------------------------------------------------------------
                                Logo_Detect.py - This script is used for detecting
                    Logos of Courier Companies - DHL, FedEx, Amazon Prime, USPS on Delivery Vans
                                        using Tensorflow Lite Interpreter
                                        ** ML Model:LogoModel.tflite **
            -----------------------------------------------------------------------------------------------------
'''
#Importing libraries
import os
...
# Add path to TFLIte model "LogoModel.tflite"
PATH_TO_CKPT = "LogoModel.tflite"
# Path to label map file "label_map_logoModel.txt"
PATH_TO_LABELS = "label_maps/label_map_logoModel.txt"
